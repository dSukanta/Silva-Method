...
function MemberShipPricingPlan() {
    return (
       <>
       <div className="container" style={{marginTop:"80px"}}>
        <div className="row justify-content-center">
            <div className="col-sm-12 col-md-8">
                <h2 className='text-center'>Become a Silva Method Member To Start</h2>
                ...
                alt="" />
                <div>
                    <h3 className='text-start'>What You Get:</h3>
                    ...
                    <TiTick size={40} color='purple' />
                    <p className='pricingplan' style={{color:"black",fontSize:"1.1rem",fontWeight:"bold"}}>
