        ...
        <div className='container mt-5 mb-5'>
            <div className="row justify-content-center align-items-center gap-3">
                <div className="col-sm-12 col-md-6">
                    ...
                    /> */}
                    <ReactPlayer width={"100%"} height={"450px"} controls url='https://www.youtube.com/watch?v=zkHbJhsaNTI&feature=youtu.be' />
                </div>
...

                {
                    isDesktopOrLaptop ? (
                        <>
                            ...
                            <div className="col-sm-12 col-md-6">
                                <ReactPlayer width={"100%"} height={"450px"} controls url='https://www.youtube.com/watch?v=J4XNaRIhFxU' />
                            </div>
                        </>
                    ) : (
                        <>
