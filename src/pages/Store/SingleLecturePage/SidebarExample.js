                            ...
                            <p className='text-start white-color'>{val.title} <br /> {val.completed}</p>
                            {
                                val.lessons.map((value,i)=>(
                                    <div className='d-flex justify-content-between'>
                                        <img src={value.img} style={{width:"100px",height:"40px",marginBottom:"15px"}} />
                                        <div className='d-flex flex-column align-items-center justify-content-center'>
                                           <h6 className='white-color'>{value.title}</h6>
                                           <p className='white-color'>{value.duration}</p>
                                           
                                        </div>
                                        {
                                             value.completed?(
                                                <IoMdDoneAll size={30} color={"white"} />
                                             ):(
