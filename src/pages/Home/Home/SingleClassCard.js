...
function SingleClassCards({data}) {
  ...
  //console.log(data);
    return (
                ...
                <div className="col-sm-10 col-md-5 col-lg-4" style={{marginLeft:(isDesktopOrLaptop || isBigScreen || isTabletOrMobile)?"0px":"35px"}}>
                    <Card className="text-start cardbody" style={{ borderRadius: "20px",width:"90%",height:(isDesktopOrLaptop || isBigScreen || isTabletOrMobile) ?"400px":"auto"}}>
